...
public class InputView {
    private static final String INPUT_FUNCTION_SELECTION = "\n## 원하는 기능을 선택하세요.";
    private static final String INPUT_SRC_STATION_MESSAGE = "\n## 출발역을 입력하세요.";
    private static final String INPUT_DST_STATION_MESSAGE = "\n## 도착역을 입력하세요.";
